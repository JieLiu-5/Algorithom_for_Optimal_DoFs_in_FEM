...
\addplot[black,mark=diamond,mark options={color=black,fill=black}] coordinates {(0,2.0e-17) (1,5.0e-17) (2,2.0e-17)};
\addplot[blue,mark=diamond,mark options={color=blue,fill=blue}] coordinates {(0,5.0e-17) (1,5.0e-17) (2,2.0e-17)};
\addplot[red,mark=diamond,mark options={color=red,fill=red}] coordinates {(0,1.0e-15) (1,5.0e-16) (2,5.0e-16)};
\legend{$u$, $u_x$, $u_{xx}$};
\end{axis}
\end{tikzpicture}
}
...
\addplot[black,mark=square,mark options={color=black,fill=black}] coordinates {(0, 1.0e-19) (1, 1.0e-19) (2, 1.0e-17)};
\addplot[blue,mark=square,mark options={color=blue,fill=blue}] coordinates {(0, 5.0e-17) (1, 1.0e-17) (2, 1.0e-17)};
\addplot[red,mark=diamond,mark options={color=red,fill=red}] coordinates {(0,2.0e-16) (1,5.0e-15) (2,2.0e-16)};
...
%The relation between $\alpha_{\rm R}$ and $\|u\|_2$ or $\|u_x\|_2$ are summarized in Table~\ref{Fig:py_offset_summary}.

\begin{figure}[!ht]
	\hspace{2.5cm}
    \begin{subfigure}{5.4cm}
        \includegraphics[width=1.0\linewidth]{py_offset_summary_Pois_sm.pdf}
        \caption{The standard FEM}
        \label{Fig:py_offset_summary_Pois_sm}
    \end{subfigure}
    \hspace{-0.2cm}
    \begin{subfigure}{5.4cm}
        \includegraphics[width=1.0\linewidth]{py_offset_summary_Pois_mm.pdf}
        \caption{The mixed FEM}
...
\begin{figure}[!ht]
	\hspace{2.5cm}
    \begin{subfigure}{5.4cm}
        \includegraphics[width=1.0\linewidth]{py_offset_summary_diff_sm.pdf}
        \caption{The standard FEM}
        \label{Fig:py_offset_summary_diff_sm}
    \end{subfigure}
    \hspace{-0.2cm}
    \begin{subfigure}{5.4cm}
        \includegraphics[width=1.0\linewidth]{py_offset_summary_diff_mm.pdf}
        \caption{The mixed FEM}
...
\begin{figure}[!ht]
	\hspace{2.5cm}
    \begin{subfigure}{5.4cm}
        \includegraphics[width=1.0\linewidth]{py_offset_summary_Helm_sm.pdf}
        \caption{The standard FEM}
        \label{Fig:py_offset_summary_Helm_sm}
    \end{subfigure}
    \hspace{-0.2cm}
    \begin{subfigure}{5.4cm}
        \includegraphics[width=1.0\linewidth]{py_offset_summary_Helm_mm.pdf}
        \caption{The mixed FEM}
