...
\addplot[black,mark=diamond,mark options={color=black,fill=black}] coordinates {(0,2.0e-17) (1,5.0e-17) (2,1.0e-15)};
\addplot[blue,mark=diamond,mark options={color=blue,fill=blue}] coordinates {(0,5.0e-17) (1,5.0e-17) (2,5.0e-16)};
\addplot[red,mark=diamond,mark options={color=red,fill=red}] coordinates {(0,2.0e-17) (1,2.0e-17) (2,5.0e-16)};
...
%5 & $0$ & ${c}^{-1} x$ & 1e-4, 1e-2, 1e0, 1e2, 1e4 \\ \hline
\end{tabular}
\end{table}
...
\begin{table}[!ht]
\captionof{table}{Relation between $\alpha_{\rm R}$ and a variety of $L_2$ norms for the second-order differential equations.}
\centering
\begin{tabular}{l c l}
\hline
...
\bibliography{3_writing/1_1d/mybibfile}  %%% Remove comment to use the external .bib file (using bibtex).
